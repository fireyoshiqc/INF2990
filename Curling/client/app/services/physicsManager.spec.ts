...
describe('PhysicsManager', () => {
    ...
    describe('update()', () => {
        it('should update the curling stone position according to its speed.', done => {
            ...
            testPhysicsManager.addStone(new CurlingStone(new THREE.Vector3(0, 0, 1), new THREE.Vector3(0, 0, 0)));
        ...
        it('should update the direction of a curling stone after a collision.', done => {
            ...
            let stone1 = new CurlingStone(new THREE.Vector3(0, 0, 1), new THREE.Vector3(0, 0, 0));
            let stone2 = new CurlingStone(new THREE.Vector3(0, 0, -1), new THREE.Vector3(0, 0, 1));
